...
Ball::Ball(float x, float y, color_t color,color_t color_fire)
{
    ...
    */
    ...
    static const GLfloat vertex_buffer_data_fire[] = {
        -r*1.0f, -r*1.2f, 0.0f,
        0.0f, r*-1.2f, 0.0f,
        -r*1.0f, -r*1.7f, 0.0f,
        r*1.0f, -r*1.2f, 0.0f,
    ...
    this->fire = create3DObject(GL_TRIANGLES, 2*3, vertex_buffer_data_fire, color_fire, GL_FILL);
...
void Ball::draw_fire(glm::mat4 VP)
{
    Matrices.model = glm::mat4(1.0f);
    glm::mat4 translate = glm::translate (this->position);    // glTranslatef
    glm::mat4 rotate    = glm::rotate((float) (this->rotation * M_PI / 180.0f), glm::vec3(0, 0, 1));
